...
> this file (highest priority) and, on v1.20.3+ (Mar 2026), also reads `AGENTS.md`. To avoid
> two copies of the rules, keep the real rules in `AGENTS.md` and use this file only as a
> pointer plus any Antigravity-only overrides.
